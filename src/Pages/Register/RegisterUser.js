...
function RegisterUser() {
    ...
    useEffect(() => {
        ...
        metaDesc.content = "Đăng ký tài khoản để trải nghiệm mua sắm.";
    }, []);
    ...
    return (
        <>
            <Helmet>
                <title>Đăng Ký</title>
                <meta name="description" content="Đăng ký tài khoản để trải nghiệm mua sắm." />
                <meta name="keywords" content="đăng ký, tạo tài khoản" />
            </Helmet>
            <ToastContainer />
            <header>
                <Header />
