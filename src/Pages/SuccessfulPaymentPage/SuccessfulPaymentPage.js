...
function SuccessfulPaymentPage() {
    ...
    useEffect(() => {
        ...
        metaDesc.content = "Thông báo đã thanh toán thành công";
    }, []);

    return (
        <><Helmet>
                <title>Successful Payment</title>
                <meta name="description" content="Thông báo đã thanh toán thành công." />
                <meta name="keywords" content="Successful Payment" />
            </Helmet>
