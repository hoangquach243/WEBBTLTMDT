...
function ProductDetail({product}) {
    ...
    useEffect(() => {
        ...
        metaDesc.content = "Xem chi tiết sản phẩm.";
    }, []);
    ...
    return (
        <><Helmet>
                <title>{dataProducts?.nameProducts || 'Chi tiết sản phẩm'}</title>
                <meta name="description" content={dataProducts?.des || 'Xem chi tiết sản phẩm.'} />
                <meta name="keywords" content="chi tiết sản phẩm, thời trang" />
            </Helmet>
