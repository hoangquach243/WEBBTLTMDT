...
function Checkout() {
    ...
    useEffect(() => {
        ...
        metaDesc.content = "Thanh toán đơn hàng nhanh chóng, an toàn.";
    }, []);

    return (
        <><Helmet>
                <title>Thanh Toán</title>
                <meta name="description" content="Thanh toán đơn hàng nhanh chóng, an toàn." />
                <meta name="keywords" content="thanh toán, mua hàng" />
            </Helmet>
